...
export const MCP_CONTROL_TOOLS: Tool[] = [
  {
    name: 'vidit_status',
    description: 'Show connected Vidit editors, this transport session binding, and capability status.',
    inputSchema: { type: 'object', properties: {} },
    annotations: { readOnlyHint: true, destructiveHint: false, idempotentHint: true, openWorldHint: false },
  },
  {
    name: 'list_projects',
    description: 'List Vidit projects, newest first.',
    inputSchema: {
      type: 'object',
      properties: {
  ...
  {
    name: 'create_project',
    description: 'Create an empty Vidit project with one active timeline and one video track.',
    inputSchema: {
      type: 'object',
      properties: {
        name: { type: 'string' },
  ...
  {
    name: 'get_editor_url',
    description: 'Return the Vidit editor URL for this session project or an explicitly named project.',
    inputSchema: {
      type: 'object',
      properties: { projectId: { type: 'string' }, editorBaseUrl: { type: 'string' } },
    },
