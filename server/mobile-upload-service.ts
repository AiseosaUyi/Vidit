...
function mobilePage(locale: MobilePageLocale): string {
  ...
  const copy = {
    en: {
      pageTitle: 'Upload from phone', title: 'Send media to Vidit',
    ...
    ru: {
      pageTitle: 'Загрузка с телефона', title: 'Отправить медиафайлы в Vidit',
    ...
    zh: {
      pageTitle: '手机传素材', title: '发送素材到 Vidit',
...
<title>Vidit · ${copy.pageTitle}</title><style>
