...
assert.match(main, /vidit:reveal-export/, 'Electron main must own the filesystem reveal operation');
...
assert.match(history, /r\.destinationId && window\.viditDesktop\?\.revealExport/, 'legacy and browser rows must not offer reveal');
