  ...
  },
  {
    ...
    input_schema: {
      ...
      properties: {
        ...
        stream: { type: 'boolean', description: 'MiniMax HTTP streaming transport. Vidit consumes it server-side and saves one durable audio asset.' },
  ...
  },
  {
    ...
    input_schema: {
      ...
      properties: {
        ...
        stream: { type: 'boolean', description: 'Mureka only. Enable provider streaming phase; Vidit still saves durable final files.' },
