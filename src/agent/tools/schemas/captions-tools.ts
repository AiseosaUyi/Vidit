...
export const CAPTIONS_TOOL_SCHEMAS: AgentToolSchema[] = [
  ...
  },
  {
    ...
    description:
      ...
      "- template: no arg → list the 34 built-in presets; `templatePreset:\"netflix\"` → apply one (size/position preserved).\n" +
      ...
      "- animation: deterministic burn-in motion shared by preview/export; set `motionPreset` to none, fade-up, pop, word-pop, karaoke-pulse, typewriter, slide-in-word, bounce-in-page, or shake-emphasis.\n" +
