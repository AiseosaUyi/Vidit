...
Do not pass MiniMax cover controls, `lyricsOptimizer`, or Mureka IDs/modes. Submission is a single paid POST. Vidit records the prediction ID, polls with bounded backoff, and can resume polling without submitting another generation.
