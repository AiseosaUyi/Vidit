...
// name services Vidit does not expose the same way. This module scans a
  ...
  for (const dep of deps) {
    ...
    if (dep.kind === 'runtime') {
      lines.push(
        ...
        + 'You are the Vidit built-in agent: run the same deterministic steps with THIS environment\'s tools '
