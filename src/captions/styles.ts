...
export const CAPTION_STYLES: CaptionStyle[] = [
  ...
  { id: 'podcast-lowerthird', label: 'Podcast Lower-Third', labelZh: '播客下三分之一', hint: '访谈节目名字条风格', fontFamily: 'DM Sans', fontSize: .034, fontWeight: 700, color: '#fff', highlightColor: '#fff', highlightBackground: '#2B6CFF', strokeColor: '#000', strokeWidth: 0, textShadow: 'none', wholeLine: true, background: '#0B0F1Ae6', textAlign: 'left' },
  { id: 'breaking-news', label: 'Breaking News', labelZh: '新闻快讯', hint: '红底白字新闻插播风格，全大写', fontFamily: 'Archivo Black', fontSize: .036, fontWeight: 400, color: '#fff', highlightColor: '#fff', highlightBackground: '#D6001C', strokeColor: '#000', strokeWidth: 0, textShadow: 'none', textTransform: 'uppercase', wholeLine: true, background: '#D6001C' },
  { id: 'corporate-clean', label: 'Corporate Clean', labelZh: '商务简洁', hint: '网络研讨会/企业演示风格', fontFamily: 'Inter', fontSize: .034, fontWeight: 600, color: '#1A2332', highlightColor: '#1A2332', highlightBackground: '#E8EDF5', strokeColor: '#000', strokeWidth: 0, textShadow: 'none', wholeLine: true, background: '#FFFFFFE6', boxBorderColor: '#1A2332', boxBorderWidth: 1, boxBorderOpacity: .15 },
  { id: 'handwritten-note', label: 'Handwritten Note', labelZh: '手写便签', hint: '手写字体，暖黄便签感', fontFamily: 'Caveat', fontSize: .055, fontWeight: 700, color: '#3A2E1A', highlightColor: '#3A2E1A', highlightBackground: '#FFE9A8', strokeColor: '#000', strokeWidth: 0, textShadow: 'none' },
];
